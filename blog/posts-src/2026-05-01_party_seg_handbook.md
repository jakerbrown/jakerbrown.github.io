...
Prepared a [piece](https://jacobrbrown.com/files/partisan_seg_chapter.pdf) for the forthcoming *Handbook of American Political Geography*. Some tidbits deserve emphasis: 
...
The most interesting demographic here to me is one where voters are realigning but also where the mass of the distribution is [imbalanced](https://cup.columbia.edu/book/generation-gap/9780231200875/): 
